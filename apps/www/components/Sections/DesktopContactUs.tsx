...
import { Button, IconGitHub, IconArrowLeft, IconArrowRight, IconBookOpen, IconPhoneOutgoing, IconMail } from 'ui'
    ...
    <>
      <div className="grid grid-cols-12">
        <div className="col-span-12 text-center">
          <h2 className="h3">Contact us now</h2>
          {/* <p className="p ">
          ...
          <div className="flex items-center justify-center gap-2 py-4">
            <Link href="/docs/guides/auth/overview" passHref>
              <a>
                <Button size="small" type="default" icon={<IconPhoneOutgoing size={12} />}>
                  Call us!
                </Button>
              </a>
            </Link>
            ...
            >
              <a>
                <Button size="small" type="default" icon={<IconMail size={12} />}>
                  Email us!
                </Button>
              </a>
            </Link>
